...
public class PlannerAgent extends Agent
{
     ...
     * being that your nodes are now GameState objects not MapLocation objects.
     *
     ...
     * actions should have a form matching your included Strips definition
     * writeup. That is <action name>(<param1>, ...). So for instance the
     * move action might have the form of Move(peasantID, X, Y) and when
     * grounded and written to the file Move(1, 10, 15).
     *
