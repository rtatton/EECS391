...
{
    /**
     * Calculate a random integer between a given lower and upper bound. If the
     * bounds are equal, then the lower bound is returned.
     *
     * @param min Lower bound of the random integer.
     * @param max Upper bound of the random integer.
     * @return Random integer.
     * @throws IllegalArgumentException Thrown when the lower bound is greater
